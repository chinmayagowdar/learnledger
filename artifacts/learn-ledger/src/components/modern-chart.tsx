    ...
    >
      ...
      <ResponsiveContainer width="100%" height={height}>
        <AreaChart data={chartData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
          ...
          <Tooltip
            contentStyle={{ backgroundColor: 'rgba(20, 20, 40, 0.95)', border: '1px solid rgba(255, 255, 255, 0.2)', borderRadius: '8px', padding: '8px 12px' }}
            labelStyle={{ color: '#fff' }}
          />
          <Area type="monotone" dataKey="completions" stroke="rgb(84, 153, 255)" fillOpacity={1} fill="url(#colorCompletions)" name="Assessments" />
          <Area type="monotone" dataKey="credentials" stroke="rgb(147, 112, 219)" fillOpacity={1} fill="url(#colorCredentials)" name="Credentials" />
        </AreaChart>
      </ResponsiveContainer>
