...
const skills = [
  {
    id: 'react-advanced',
    name: 'React Advanced',
    description: 'Master advanced React patterns, hooks, and optimization techniques',
    level: 'Advanced',
    rounds: 3,
    questionsPerRound: 5,
  },
  {
    ...
    description: 'Deep dive into JavaScript fundamentals, async patterns, and modern ES6+',
    level: 'Advanced',
    rounds: 3,
    questionsPerRound: 5,
  },
  {
    id: 'typescript-pro',
    name: 'TypeScript Pro',
    description: 'Advanced TypeScript concepts, generics, conditional types, and patterns',
    level: 'Advanced',
    rounds: 3,
    questionsPerRound: 5,
  },
          ...
          {skills.map((skill, index) => (
            ...
            >
              <div className="glass rounded-xl p-6 h-full flex flex-col justify-between border border-primary/20 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/20 transition-all duration-300">
                ...
                >
                  <Button className="w-full bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-white rounded-lg group/btn">
                    Start Assessment
